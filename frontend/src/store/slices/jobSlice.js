...
export const fetchSingleJob = (jobId) => async(dispatch) => {
    ...
    try {
        const response = await axios.get(
            `http://localhost:4000/api/v1/job/get/${jobId}`, { withCredentials: true }
        );
...
export const getMyJobs = () => async(dispatch) => {
    ...
    try {
        const response = await axios.get(
            `http://localhost:4000/api/v1/job/getmyjobs`, { withCredentials: true }
        );
...
export const deleteJob = (id) => async(dispatch) => {
    ...
    try {
        const response = await axios.delete(
            `http://localhost:4000/api/v1/job/delete/${id}`, { withCredentials: true }
        );
